Namespace Utilities
    ...
    Friend Class UserInputChecker
        ...
        ''' <summary>
        ''' The confirmation message displayed to the user when prompting them to proceed with the installation of the registry key.
        ''' </summary>
        ''' <remarks>
        ...
        ''' of the registry key. The user is expected to enter 'Y' to indicate their consent to proceed.
        ''' </remarks>
        Private Const ConfirmationMessage As String = "Please confirm whether you would like to proceed with the installation of the registry key by entering 'Y'"
        ...
        ''' with the installation of the registry key.
        ''' </remarks>
        ...
        ''' with actions such as installing a registry key. The method returns <c>True</c> if the input matches the confirmation character 'Y'
