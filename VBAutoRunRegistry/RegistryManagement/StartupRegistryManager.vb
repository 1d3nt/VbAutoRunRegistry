Namespace RegistryManagement
    ...
    Friend Class StartupRegistryManager
        ...
        ''' </summary>
        Public Sub InstallStartupKey() Implements IStartupRegistryManager.InstallStartupKey
        ...
        ''' </summary>
        Public Sub UninstallStartupKey() Implements IStartupRegistryManager.UninstallStartupKey
            Using key As IRegistryKey = GetStartupKey()
